...

{
    ...
    fs_create("user1", "password1", session2, seq++, "/dir/eecs482/p1", 'f');
    ...
    fs_writeblock("user1", "password1", session2, seq++, "/dir/file", 0, writedata);
    fs_writeblock("user1", "password1", session2, seq++, "/dir/file", 0, writedata2);
    fs_writeblock("user1", "password1", session, seq++, "/dir/file", 20, writedata2);
    fs_writeblock("user1", "password1", session2, seq++, "/dir/file", 20, writedata2);
